...
// Zada4aOne.cpp : Определяет поведение классов для приложения.
//

#include "stdafx.h"
#include "Zada4aOne.h"
#include "Zada4aOneDlg.h"
...
BEGIN_MESSAGE_MAP(CZada4aOneApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CZada4aOneApp

CZada4aOneApp::CZada4aOneApp()
{
...
// Единственный объект CZada4aOneApp

CZada4aOneApp theApp;


// инициализация CZada4aOneApp

BOOL CZada4aOneApp::InitInstance()
{
